...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/mjos/Library/Application Support/luaglider2/dev";local SOCKET_PORT=31066;local GLIDER_MAIN_FOLDER= "/Users/mjos/Desktop/corona/angry birds";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
